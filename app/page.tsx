    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <a href="/sample-request" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
          ...
          <a href="/admin/dashboard" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
            <h2 className="text-xl font-semibold mb-2">Admin Dashboard</h2>
            <p className="text-gray-600">View and manage clearance requests</p>
          </a>

          <a href="/chat" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
